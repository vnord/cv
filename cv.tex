...
\section{Education \hfill \href[gray]{https://vnord.net/transcript.pdf}{\textit{\small Transcript from June 2, 2020 available at vnord.net/transcript.pdf} \faDownload}}

\entry{2018-2020}
    {MSc. in Computer Science - Algorithms, Languages and Logic}
    {\ch, Gothenburg}
    {\\\textit{Thesis title:} Ray Tracing for Sensor Simulation using Parallel Functional Programming \\\textit{Thesis company:} Volvo Cars, Gothenburg
     ...
     \\\textit{\color{gray}The thesis will soon be published, and this document will then be updated with a download link here}}
...
I only use GNU/Linux-based operating systems --- primarily Arch Linux -- on my personal systems,
...
\textbf{Python}, \textbf{Rust}, \textbf{JavaScript}, \textbf{PureScript}, and some assembly languages. I am
